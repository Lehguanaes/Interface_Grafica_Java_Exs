 ...
 */
public class Exercicio_Hablilitar_Desabilitar extends JFrame{
    ...
    public Exercicio_Hablilitar_Desabilitar(){
        // TITULO DA PÁGINA
        super("Textos");
     ...
     public static void main(String[] args) {
        ...
        Exercicio_Hablilitar_Desabilitar start = new  Exercicio_Hablilitar_Desabilitar();
